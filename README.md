...
```
/Applications/Processing.app/Contents/PlugIns/jdk-17.0.8+7/Contents/Home/bin/javac -Xlint:none -cp "/Applications/Processing.app/Contents/Java/core.jar" -d ../../../../libs/ **/*.java
```
